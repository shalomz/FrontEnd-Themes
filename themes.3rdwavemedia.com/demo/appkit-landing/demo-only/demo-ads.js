var filename='http://themes.3rdwavemedia.com/demo/appkit-landing/demo-only/demo-ads.css?' + new Date().getTime();		
...
function checkAd() {
	...
	if (adImgHeight >= 30) {
		_gaq.push(['_trackEvent', 'AppKit Landing Theme Demo Ad', 'Carbon Ad VISIBLE','Carbon Ad']);
...
if(window._gaq) {
	_gaq.push(['_trackEvent', 'AppKit Landing Theme Demo Ad', 'Carbon ad included', '1']);
