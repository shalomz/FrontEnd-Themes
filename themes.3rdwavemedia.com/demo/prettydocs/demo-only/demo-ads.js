var filename='http://themes.3rdwavemedia.com/demo/prettydocs/demo-only/demo-ads.css?' + new Date().getTime();		
...
function checkAd() {
	...
	if (adImgHeight >= 30) {
		_gaq.push(['_trackEvent', 'PrettyDocs Theme Demo Ad', 'Carbon Ad VISIBLE','Carbon Ad']);
...
if(window._gaq) {
	_gaq.push(['_trackEvent', 'PrettyDocs Theme Demo Ad', 'Carbon ad included', '1']);
